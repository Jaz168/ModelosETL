...
/* 
    ...
    loader.load( './src/modelos/pr2_head_pan.stl', function ( geometry ) {
    ...
    loader.load( './src/modelos/pr2_head_tilt.stl', function ( geometry ) {
    ...
    Colored binary STL
    loader.load( './src/modelos/colored.stl', function ( geometry ) {
